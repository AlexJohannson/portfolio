...
export const JavaScriptComponent = () => {
    return (
        <>
            <div className='javascript'>
                <div className='text-javascript'>
                    <h2>Name/Value Application</h2>
                    <p>This is a simple and responsive JavaScript-based application for managing a list of
                        name = value pairs. Users can add, sort, and delete entries through an intuitive interface
                        with real-time syntax validation.
                    </p>
                    <h4>Tools I used:</h4>
                    <p>HTML5</p>
                    <p>CSS3</p>
                    ...
                    <p>Responsive design techniques</p>
